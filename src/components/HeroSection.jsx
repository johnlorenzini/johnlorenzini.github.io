      ...
      <div id="text" className='col-start-4 col-span-3 md:pr-20 -translate-y-10 sm:translate-y-4 md:translate-y-0'>
        ...
        <div id="icons" className='pb-5 md:pb-10 flex flex-row justify-center md:justify-end'>
          <a href='https://www.linkedin.com/in/jlorenzi/' target='_blank' rel='noopener noreferrer' className=''>
            <img src={theme === "light" ? "/src/img/light/linkedin.png" : "/src/img/dark/linkedin.png"} alt="connect on linkedin" className="hover:drop-shadow-xl transition duration-300 ease-in-out saturate-0 dark:brightness-200 hover:scale-110 dark:invert-0 dark:hover:brightness-100 hover:invert-0 hover:cursor-pointer hover:saturate-100 invert mx-2 w-8 md:pt-2 sm:w-10"></img>
          </a>
          <a href='https://github.com/johnlorenzini' target='_blank' rel='noopener noreferrer' className=''>
            <img src={theme === "light" ? "/src/img/light/github.png" : "/src/img/dark/github.png"} alt="my code on github" className="hover:drop-shadow-xl transition duration-300 ease-in-out saturate-0 dark:brightness-200 hover:scale-110 dark:invert-0 dark:hover:brightness-100 hover:invert-0 hover:cursor-pointer hover:saturate-100 invert mx-2 w-8 md:pt-2 sm:w-10"></img>
          </a>
          <a href='https://www.instagram.com/johnloren99/' target='_blank' rel='noopener noreferrer' className=''>
            <img src={theme === "light" ? "/src/img/light/instagram.png" : "/src/img/dark/instagram.png"} alt="follow my instagram" className="hover:drop-shadow-xl transition duration-300 ease-in-out saturate-0 dark:brightness-200 hover:scale-110 dark:invert-0 dark:hover:brightness-100 hover:invert-0 hover:cursor-pointer hover:saturate-100 invert mx-2 w-8 md:pt-2 sm:w-10"></img>
          </a>
        </div>
