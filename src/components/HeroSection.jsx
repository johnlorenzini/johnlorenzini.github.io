  ...
  return (
    <div className='flex flex-col h-screen md:grid md:grid-cols-6 py-20 items-center md:items-end justify-center md:content-center'>
      <div id="image" className='md:col-start-1 lg:col-start-1 lg:col-span-3 md:col-span-3 md:place-self-auto'>  
        <img src='/src/refs/pfp.png' alt='headshot' className='hover:shadow-md md:hover:shadow-lg hover:shadow-emerald-400 md:hover:shadow-emerald-400 dark:hover:shadow-green-400 w-56 m-auto sm:w-80 md:w-96 lg:w-96 transition ease-in-out duration-300 rounded-full border-4 md:border-8 border-emerald-400 dark:border-green-400 hover:scale-105' />
      </div>
      <div id="text" className='col-start-4 col-span-3 md:pr-20'>
        <h1 className='text-center md:text-right transition ease-in-out hover:drop-shadow-2xl duration-300 scale-50 sm:scale-75 md:translate-x-16 lg:translate-x-0 lg:scale-100 text-8xl mb-0 md:mb-0 pt-5 md:pt-0 text-green-400 dark:text-emerald-400 font-bold hover:scale-110'>john
        <br/><span className='text-emerald-400 dark:text-green-400'>lorenzini</span>
        </h1>
        <h1 className='text-center md:text-right transition ease-in-out hover:drop-shadow-2xl duration-300 scale-50 sm:scale-75 lg:scale-100 text-8xl mb-1 md:mb-3 text-emerald-400 dark:text-green-400 font-bold hover:scale-110'>lorenzini</h1>
