    ...
    <>
      <div id="card" data-aos="fade-up" data-aos-easing="ease" data-aos-duration="800" className='m-auto flex justify-center py-16 cardBG shadow-xl border-2 border-white border-opacity-10 rounded-2xl'>
          <div id="inner" className='max-w-xl'>
              <a href="https://www.linkedin.com/in/jlorenzi" alt="/" target="_blank"><img src={"./img/memoji/light/memoji" + (Math.floor(Math.random()*4)+1) + ".png"} alt="" className='m-auto drop-shadow-md hover:drop-shadow-xl w-1/3 md:w-1/2 transition ease-in-out duration-500 hover:scale-105 hover:-translate-y-3'/></a>
