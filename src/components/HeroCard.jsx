    ...
    <>
      <div id="card" data-aos="fade-up" data-aos-easing="ease" data-aos-duration="800" className='m-auto flex justify-center py-16 cardBG shadow-xl border-2 border-white border-opacity-10 rounded-2xl'>
          <div id="inner" className='max-w-xl'>
              ...
              <h1 className='transition ease-in-out duration-500 text-center py-5 md:py-10 text-zinc-900 dark:text-white drop-shadow-md font-bold text-2xl md:text-4xl'>hi! i'm <span className='transition-colors ease-in-out duration-300 bg-clip-text text-transparent bg-gradient-to-t from-amber-500 to-red-300 dark:from-purple-900 dark:to-purple-600'>john.</span></h1>
              <a href="http://www.github.com/johnlorenzini" alt="/" target="_blank" className='text-center '> <p className='text-amber-500 dark:text-purple-900 text-sm md:text-xl font-semibold m-auto transition ease-in-out duration-500 hover:-translate-y-1 hover:drop-shadow-sm hover:underline hover:decoration-4 md:hover:underline-offset-4'>developer</p> </a>
              <p className='transition ease-in-out duration-500 text-zinc-900 dark:text-white text-center text-xs md:text-lg font-semibold'>computer science student at <a href="http://www.uci.edu" target="_blank" className='transition ease-in-out text-amber-500 dark:text-purple-900 hover:text-yellow-500 dark:hover:text-yellow-500'>uc irvine</a></p>
